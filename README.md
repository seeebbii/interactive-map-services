...
app/
  ...
  page.tsx                 landing/map view (server component)
  globals.css              design tokens + tailwind directives
components/
  Header.tsx               title, search, top stats
  ...
  Map/
    WorldMap.tsx           orchestrator (projection, zoom, loading)
    CountryShape.tsx       per-country motion.g + Geography
    AppMarkers.tsx         centroid bubbles with pulse
...
lib/
  ...
  store/
    useMapStore.ts         Zustand store for selection, filter, motion
public/
